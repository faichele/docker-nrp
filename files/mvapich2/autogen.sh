...
( cd src/glue/romio && chmod a+x ./all_romio_symbols && sync && ./all_romio_symbols ../../mpi/romio/include/mpio.h.in )
echo "done"
...
if [ $do_bindings = "yes" ] ; then
	...
	( cd src/binding/fortran/mpif_h && chmod a+x ./buildiface && sync && ./buildiface )
	echo "done"
    fi
	...
	( cd src/binding/fortran/use_mpi && chmod a+x ./buildiface && sync && ./buildiface )
	...
	# Top-level files
	( cd src/binding/fortran/use_mpi_f08 && chmod a+x ./buildiface && sync && ./buildiface )
        # Delete the old Makefile.mk
        ( rm -f src/binding/fortran/use_mpi_f08/wrappers_c/Makefile.mk )
        # Execute once for mpi.h.in ...
	( cd src/binding/fortran/use_mpi_f08/wrappers_c && chmod a+x ./buildiface && sync && ./buildiface ../../../../include/mpi.h.in )
        # ... and once for mpio.h.in
	( cd src/binding/fortran/use_mpi_f08/wrappers_c && chmod a+x ./buildiface && sync && ./buildiface ../../../../mpi/romio/include/mpio.h.in )
	echo "done"
    fi
	...
	( cd src/binding/cxx && chmod a+x ./buildiface && sync && 
